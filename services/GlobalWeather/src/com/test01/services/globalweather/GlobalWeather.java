 ...
 * 2017-11-03T06:04:54.611Z
 * Generated source version: 2.7.11
 * 
 */
@WebServiceClient(name = "GlobalWeather", 
                  wsdlLocation = "GlobalWeather.wsdl",
...
public class GlobalWeather extends Service {
    ...
    static {
        URL url = GlobalWeather.class.getResource("GlobalWeather.wsdl");
        if (url == null) {
            url = GlobalWeather.class.getClassLoader().getResource("GlobalWeather.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(GlobalWeather.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "GlobalWeather.wsdl");
        }       
        WSDL_LOCATION = url;
    }
